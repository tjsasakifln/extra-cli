...
| Role | Value |
|------|-------|
| actual_pr_head_sha | `807b57ed6b64ff4b383e1e6f84a9782d522db125` |
...
| Field | Value |
|-------|-------|
| latest_workflow_run_id | `30215931047` |
| latest_workflow_status | `PASS` |
| human_artifact_id | `8635804232` |
| machine_artifact_id | `8635809570` |
...
1. HEAD real da PR: `807b57ed6b64ff4b383e1e6f84a9782d522db125`
2. Merge SHA Actions: `c0ae4fe1403a96b9dc6fc2464e091de39254f7ad`
