...
**Terminal status:** `BLOCKED_INSUFFICIENT_REAL_GOLD_CORPUS`
**Active blockers:** `BLOCKED_EMBEDDING_OPERATIONAL_VALIDATION, BLOCKED_FULL_SUITE_VALIDATION, BLOCKED_INSUFFICIENT_REAL_GOLD_CORPUS, BLOCKED_INSUFFICIENT_STATISTICAL_POWER, BLOCKED_LLM_OPERATIONAL_VALIDATION`
**Evaluation level:** `C`
...
- **HIGH**: terminal=BLOCKED_INSUFFICIENT_REAL_GOLD_CORPUS — close real-corpus/LLM/capacity/full-suite gates before RC v3
