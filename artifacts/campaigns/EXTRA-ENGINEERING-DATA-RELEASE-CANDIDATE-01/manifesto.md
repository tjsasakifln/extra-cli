...
| #560 | #548 | `98c711f5e4c385a150267a059cd01d59eb2a7854` + sticky `95637782` | `7cb9bc85`, `95637782` | INCLUDE_REVENUE_NOW | Terminal terms exclude HOT/WARM/ACTIVE; undated later ADITIVO cannot clobber REVOGACAO | `contract_terms`, `lifecycle_event_last` | 112 | `tests/test_contract_terms_lifecycle.py`, sticky view case in `tests/test_engineering_data_release_candidate.py` | terms ingest not started |
