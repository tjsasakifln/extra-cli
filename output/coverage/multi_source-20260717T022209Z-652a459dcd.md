...
- Window used for recency metrics: 30 days ending 2026-07-17.
...
| `municipalities_with_publication_30d` | 74.92 | 221 | 295 | medium | pct |
| `orgs_with_recent_licitacao` | 20.31 | 222 | 1093 | medium | pct |
| `pncp_sc_reconciled` | 28.27 | 309 | 1093 | low | pct |
| `source_coverage_dados_abertos_sc` | 1.22 | 500 | 41080 | low | pct |
| `source_coverage_ciga_dom` | 74.92 | 221 | 295 | medium | pct |
| `source_coverage_sc_compras` | 0.38 | 10 | 2602 | medium | pct |
| `source_coverage_pncp` | 4.76 | 52 | 1093 | medium | pct |
| `temporal_coverage_ciga_dom` | 3.23 | 1 | 31 | medium | pct |
| `temporal_coverage_sc_compras` | 3.23 | 1 | 31 | medium | pct |
| `temporal_coverage_dados_abertos_sc` | 0.0 | 0 | 31 | medium | pct |
| `act_category_distribution_ciga_dom` | 94.74 | 18 | 19 | medium | pct |
| `act_category_distribution_dados_abertos_sc` | 94.74 | 18 | 19 | medium | pct |
| `field_completeness_ciga_dom` | 92.81 | 15943 | 17178 | high | pct |
| `field_completeness_sc_compras` | 55.56 | 50 | 90 | high | pct |
...
- **limitations:**
  ...
  - CIGA DOM run mode=smoke — partial resource selection; underestimates full coverage.
- **extras:**
  - window_start: `2026-06-17`
  - window_end: `2026-07-17`
  - observed_municipios_all_time_in_artifact: `223`
  - observed_municipios_in_window: `223`
  - matched_to_ibge_in_window: `221`
  - unmatched_name_samples: `["Herval d'Oeste", 'Grão Pará', 'Grão Pará', 'Grão Pará']`
...
- **extras:**
  ...
  - orgs_by_source: `{'sc_compras': 4, 'ciga_dom': 218, 'dados_abertos_sc': 0}`
...
- **extras:**
  - source: `ciga_dom`
  - records: `2454`
  - observed_municipios: `223`
  - run_mode: `smoke`
  - summary_counts: `{'resources_available': 44, 'zips_available': 44, 'selected': 2, 'completed_resources_prior': 0, 'resources_processed_ok': 2, 'resources_failed': 0, 'resources_skipped_checkpoint': 0, 'files_processed': 2, 'files_skipped_checkpoint': 0, 'records_normalized': 2454, 'municipalities_observed': 223}`
...
- **extras:**
  - min_date: `2026-07-16`
  - max_date: `2026-07-16`
  - min_date_in_window: `2026-07-16`
  - max_date_in_window: `2026-07-16`
  - records_with_date: `2454`
  - records_in_window: `2454`
...
- **extras:**
  ...
  - min_date_in_window: `2026-07-16`
  - max_date_in_window: `2026-07-16`
  - records_with_date: `10`
  - records_in_window: `10`
...
- **extras:**
  - total_records_classified: `2454`
  - procurement_categories_observed: `['apostilamento', 'ata_registro_precos', 'aviso_licitacao', 'chamamento_publico', 'credenciamento', 'dispensa', 'edital', 'errata', 'extrato_contrato', 'homologacao', 'inexigibilidade', 'outros_atos_contratacao', 'rescisao', 'resultado', 'retificacao', 'revogacao', 'suspensao', 'termo_aditivo']`
  - non_procurement_share_pct: `24.78`
- **distribution (top 15):**
  - ata_registro_precos: {'count': 1226, 'pct': 49.96}
  - outros: {'count': 517, 'pct': 21.07}
  - homologacao: {'count': 135, 'pct': 5.5}
  - outros_atos_contratacao: {'count': 130, 'pct': 5.3}
  - nao_relacionado: {'count': 88, 'pct': 3.59}
  - termo_aditivo: {'count': 84, 'pct': 3.42}
  - extrato_contrato: {'count': 59, 'pct': 2.4}
  - inexigibilidade: {'count': 51, 'pct': 2.08}
  - dispensa: {'count': 49, 'pct': 2.0}
  - aviso_licitacao: {'count': 24, 'pct': 0.98}
  - apostilamento: {'count': 17, 'pct': 0.69}
  - chamamento_publico: {'count': 15, 'pct': 0.61}
  - edital: {'count': 15, 'pct': 0.61}
  - retificacao: {'count': 13, 'pct': 0.53}
  - errata: {'count': 9, 'pct': 0.37}
...
- **extras:**
  ...
  - mean_field_fill_pct: `92.81`
- **per_field:**
  - municipio: {'filled': 1219, 'total': 2454, 'pct': 49.67}
  - orgao: {'filled': 2454, 'total': 2454, 'pct': 100.0}
  - data: {'filled': 2454, 'total': 2454, 'pct': 100.0}
  - titulo: {'filled': 2454, 'total': 2454, 'pct': 100.0}
  - url: {'filled': 2454, 'total': 2454, 'pct': 100.0}
  - act_category: {'filled': 2454, 'total': 2454, 'pct': 100.0}
  - texto: {'filled': 2454, 'total': 2454, 'pct': 100.0}
...
- **extras:**
  - n_records: `10`
  - fields: `['objeto_compra', 'orgao_razao_social', 'data_publicacao', 'modalidade_nome', 'link_pncp', 'municipio', 'orgao_cnpj', 'valor_total_estimado', 'documentos']`
  - mean_field_fill_pct: `55.56`
- **per_field:**
  - objeto_compra: {'filled': 10, 'total': 10, 'pct': 100.0}
  - orgao_razao_social: {'filled': 10, 'total': 10, 'pct': 100.0}
  - data_publicacao: {'filled': 10, 'total': 10, 'pct': 100.0}
  - modalidade_nome: {'filled': 10, 'total': 10, 'pct': 100.0}
  - link_pncp: {'filled': 10, 'total': 10, 'pct': 100.0}
  - municipio: {'filled': 0, 'total': 10, 'pct': 0.0}
  - orgao_cnpj: {'filled': 0, 'total': 10, 'pct': 0.0}
  - valor_total_estimado: {'filled': 0, 'total': 10, 'pct': 0.0}
  - documentos: {'filled': 0, 'total': 10, 'pct': 0.0}
...
- **limitations:**
  ...
  - Does not prove downstream DB persistence — file artifact only.
- **extras:**
  - method: `freshness-gate critical_sources[pncp]`
...
```json
{
  "ciga_dom": {
    ...
    "records": "/mnt/d/extra consultoria/output/ciga_dom/ciga-dom-20260717T021436Z-08120b3f8f/publications.jsonl",
    "n_records": 2454,
    "freshness": "/mnt/d/extra consultoria/output/ciga_dom/freshness_manifest.json"
  },
  "sc_compras": {
    "summary": "/mnt/d/extra consultoria/output/sc_compras/sc_compras-incremental-20260717T021544Z-4d70d47986/artifact.json",
    "records": "/mnt/d/extra consultoria/output/sc_compras/sc_compras-incremental-20260717T021544Z-4d70d47986/licitacoes.jsonl",
    "n_records": 10
  },
  "dados_abertos_sc": {
