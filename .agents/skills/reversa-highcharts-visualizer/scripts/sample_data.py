...
def sample_pie(items: int = 6) -> dict:
    ...
    return {"series": [{"name": "Participação", "colorByPoint": True, "data": data}], "suggested_type": "pie"}
...
def main():
    ...
    parser.add_argument("--type", "-t", choices=list(GENERATORS.keys()), help="Tipo de gráfico")
