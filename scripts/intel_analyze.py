...
Usage:
    python scripts/intel_analyze.py --input docs/intel/intel-CNPJ-slug-YYYY-MM-DD.json
    python scripts/intel_analyze.py --input data.json --top 10
    python scripts/intel_analyze.py --input data.json --model gpt-4.1-mini --output analyzed.json
    python scripts/intel_analyze.py --input data.json --review
...
def main() -> None:
    """Entry point for intel_analyze CLI."""
    ...
    parser.add_argument(
        ...
        required=True,
        metavar="JSON",
        help="JSON de entrada (output do intel_extract_docs.py com top20[]). Deve existir e ser JSON valido.",
    )
    parser.add_argument(
        "--output",
        "-o",
    ...
    if not top20:
        ...
        print("Execute intel_extract_docs.py primeiro para selecionar o top20.", file=sys.stderr)
        sys.exit(1)
