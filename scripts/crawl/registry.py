...
_RAW: list[SourceInfo] = [
    ...
    SourceInfo(
        name="pncp_arp",
        aliases=["arp", "pncp-arp"],
        module="arp_lake",
        purpose="contracts",
        capabilities=["historical_contracts", "prices"],
        authority_level="federal",
        snapshot_semantics="incremental",
        freshness_sla_hours=24,
        supports_pagination=True,
        ...
        reconciliation_strategy="key_based",
        order=13,
        description="PNCP Atas de Registro de Preço / IRP no lake canônico local",
    ),
    SourceInfo(
        name="dados_abertos_sc",
        aliases=["dados-abertos-sc", "ckan_sc"],
        module="dados_abertos_sc_crawler",
        purpose="hybrid",
        capabilities=["open_tenders"],
        authority_level="estadual",
        snapshot_semantics="incremental",
        ...
        reconciliation_strategy="key_based",
        order=14,
        description="CKAN Dados Abertos SC — recursos de licitações/pregões",
    ),
    SourceInfo(
        name="betha_atende",
        aliases=["atende", "betha"],
        module="betha_atende_crawler",
        purpose="bids",
        capabilities=["open_tenders"],
        authority_level="municipal",
        snapshot_semantics="incremental",
        ...
        reconciliation_strategy="key_based",
        order=15,
        description="Betha Atende.net — licitações públicas por ente",
    ),
    SourceInfo(
        name="ipm",
        aliases=["ipm_portal"],
        ...
        reconciliation_strategy="key_based",
        order=16,
        description="Família IPM (não IPAM) — portais públicos de licitações",
    ),
    SourceInfo(
        name="betha_egov",
        aliases=["egov_betha", "e-gov-betha"],
        module="betha_egov_crawler",
        purpose="bids",
        capabilities=["open_tenders"],
        authority_level="municipal",
        snapshot_semantics="incremental",
        ...
        reconciliation_strategy="key_based",
        order=17,
        description="Betha e-Gov (*.e-gov.betha.com.br), separado de Atende",
    ),
    SourceInfo(
        name="licitacoes_e",
        aliases=["licitacoes-e", "licitacoese"],
        module="licitacoes_e_crawler",
        purpose="bids",
        capabilities=["open_tenders"],
        authority_level="federal",
        snapshot_semantics="incremental",
        ...
        reconciliation_strategy="key_based",
        order=18,
        description="Licitações-e — mapa de superfície pública / descontinuação",
    ),
    SourceInfo(
        name="bbmnet",
        aliases=["bbm-net", "bbm"],
        module="bbmnet_crawler",
        purpose="bids",
        capabilities=["open_tenders"],
        authority_level="multi",
        snapshot_semantics="incremental",
        ...
        order=19,
        description="BBMNET — adapter público de editais por ente (Refs #262)",
        known_blockers=["live_freshness_residual"],
    ),
    SourceInfo(
        name="licitanet",
        aliases=["licita-net"],
        module="licitanet_crawler",
        purpose="bids",
        capabilities=["open_tenders"],
        authority_level="multi",
        snapshot_semantics="incremental",
        ...
        order=20,
        description="Licitanet — adapter público de editais por ente (Refs #263)",
        known_blockers=["live_freshness_residual"],
    ),
    SourceInfo(
        name="compras_br",
        aliases=["comprasbr", "cbr"],
        module="compras_br_crawler",
        purpose="bids",
        capabilities=["open_tenders"],
        authority_level="multi",
        snapshot_semantics="incremental",
        ...
        order=21,
        description="Compras BR — adapter público de editais por ente (Refs #264)",
        known_blockers=["live_freshness_residual"],
    ),
...
_ENRICHMENT: dict[str, dict[str, Any]] = {
    ...
    "pncp_arp": {
        "canonical_url": "https://pncp.gov.br/api/consulta/v1/atas",
        "geo_coverage": "BR (ARP/IRP)",
        "pagination_limits": "tamanhoPagina<=50",
        "rate_limits": "polite 1-2 rps",
        "role": "complementary",
        "known_blockers": ["implemented_not_proven_live"],
    },
    "dados_abertos_sc": {
        "canonical_url": "https://dados.sc.gov.br/api/3/action",
        "geo_coverage": "SC estadual",
        "pagination_limits": "CKAN package/resource inventory",
        "rate_limits": "public polite 1 rps",
        "role": "complementary",
        "known_blockers": ["implemented_not_proven_live"],
    },
    "betha_atende": {
        "canonical_url": "https://{slug}.atende.net/",
        "geo_coverage": "SC municipal (Atende.net)",
        "pagination_limits": "per-tenant XHR/HTML",
        "rate_limits": "polite 1 rps",
        "role": "complementary",
        "known_blockers": ["implemented_not_proven_live"],
    },
    "ipm": {
        "canonical_url": "https://{tenant}.ipmbrasil.com.br/",
        "geo_coverage": "SC municipal (família IPM)",
        "pagination_limits": "per-tenant",
        "rate_limits": "polite 1 rps",
        "role": "complementary",
        "known_blockers": ["implemented_not_proven_live", "do_not_mix_ipam"],
    },
    "betha_egov": {
        "canonical_url": "https://{slug}.e-gov.betha.com.br/",
        "geo_coverage": "SC municipal (e-Gov Betha)",
        "pagination_limits": "per-tenant",
        "rate_limits": "polite 1 rps",
        "role": "complementary",
        "known_blockers": ["implemented_not_proven_live"],
    ...
    "licitacoes_e": {
        "canonical_url": "https://www.licitacoes-e.com.br/",
        "geo_coverage": "BR (plataforma histórica BB)",
        "pagination_limits": "unknown until surface classified",
        "rate_limits": "unknown",
        "role": "complementary",
        "known_blockers": ["surface_must_be_classified"],
    },
    "bbmnet": {
        "canonical_url": "https://www.bbmnet.com.br/",
        "geo_coverage": "BR multi-ente",
        "pagination_limits": "reconciled fixture pages; live residual",
        "rate_limits": "polite 1 rps",
        "role": "complementary",
        "known_blockers": ["live_freshness_residual"],
    },
    "licitanet": {
        "canonical_url": "https://licitanet.com.br/",
        "geo_coverage": "BR multi-ente",
        "pagination_limits": "cursor/page reconciled; live residual",
        "rate_limits": "polite 1 rps",
        "role": "complementary",
        "known_blockers": ["live_freshness_residual"],
    },
    "compras_br": {
        "canonical_url": "https://comprasbr.com.br/",
        "geo_coverage": "BR multi-ente",
        "pagination_limits": "idlicitacao pages; live residual",
        "rate_limits": "polite 1 rps",
        "role": "complementary",
        "known_blockers": ["live_freshness_residual"],
    },
