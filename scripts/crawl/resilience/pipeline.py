        ...
        *,
        ...
        try:
            ...
            out = {
                ...
                "pages_reused": int((fetched.metadata or {}).get("pages_reused") or 0),
                "pages_reprocessed": int((fetched.metadata or {}).get("pages_reprocessed") or 0),
                "local_corruption_count": int((fetched.metadata or {}).get("local_corruption_count") or 0),
                "content_max_timestamp": content_max or persist_result.content_max_timestamp,
                "environment": self.config.environment,
                "execution_mode": self.config.execution_mode,
