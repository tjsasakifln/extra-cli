"""Deepen Sul DOCUMENT_REQUEST_CANDIDATE diagnostic desk pass (no national re-scan).
...
NOT an operational activation queue. Geography (Sul/SC) is a desk-review policy
hint, not structural truth for confenge_activation. Who-to-work-now remains
scripts/confenge_activation only.
"""
