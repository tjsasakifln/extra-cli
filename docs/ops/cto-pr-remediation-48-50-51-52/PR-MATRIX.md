...
> SSOT: `pr-state.json` (generated 2026-07-20T02:15:17Z). Do not hand-edit recommendations/heads without regenerating from SSOT.

| PR | Base | Head | Objetivo | DoD antes | DoD depois | Código funcional | Execução real | Testes | Riscos | Estado |
| -- | ---- | ---- | -------- | --------- | ---------- | ---------------- | ------------- | ------ | ------ | ------ |
| #48 | main | `536dacba639c` | Orquestrador CTO headless seguro AIOX/ROI | gaps segurança free-shell/always-approve | registry+veto+seal+dontAsk | scripts/cto/* security | unit/adversarial CTO | tests/cto security green; full suite SKIPPED≠green | residual full suite debt | **READY_FOR_HUMAN_REVIEW** |
