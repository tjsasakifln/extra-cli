...
**run_id:** `r2-n06c-entities`
**calc_date:** 2026-07-18
**generated_at:** 2026-07-18T21:43:47.083711+00:00
**window_days:** 30
**as_of:** 2026-07-18
...
| `municipalities_with_publication_30d` | 97.29 | 287 | 295 | medium | pct |
| `orgs_with_recent_licitacao` | 51.69 | 565 | 1093 | medium | pct |
| `pncp_sc_reconciled` | 28.27 | 309 | 1093 | low | pct |
| `source_coverage_dados_abertos_sc` | 1.22 | 500 | 41080 | low | pct |
| `source_coverage_ciga_dom` | 97.29 | 287 | 295 | medium | pct |
| `source_coverage_sc_compras` | 0.0 | 0 | 2602 | medium | pct |
| `source_coverage_pncp` | 4.76 | 52 | 1093 | medium | pct |
| `temporal_coverage_ciga_dom` | 58.06 | 18 | 31 | medium | pct |
...
| `field_completeness_ciga_dom` | 94.06 | 247703 | 263347 | high | pct |
| `field_completeness_sc_compras` | n/a | 0 | 0 | none | pct |
| `field_completeness_dados_abertos_sc` | 75.0 | 3000 | 4000 | high | pct |
| `document_coverage_ciga_dom` | 100.0 | 37621 | 37621 | high | pct |
| `document_coverage_sc_compras` | n/a | 0 | None | none | pct |
| `document_coverage_dados_abertos_sc` | 0.0 | 0 | 500 | high | pct |
| `freshness_hours_ciga_dom` | 0.47 | 0.47 | 1 | high | hours |
| `freshness_hours_sc_compras` | 34.86 | 34.86 | 1 | high | hours |
| `freshness_hours_dados_abertos_sc` | 43.5 | 43.5 | 1 | high | hours |
| `freshness_hours_pncp` | 1.38 | 1.38 | 1 | high | hours |
...
- **run_id:** `r2-n06c-entities`
- **sources:**
  - `/mnt/d/extra consultoria/output/ciga_dom/ciga-dom-20260718T211324Z-2c05d7be3f/publications.jsonl`
...
- **extras:**
  ...
  - observed_municipios_all_time_in_artifact: `289`
  - observed_municipios_in_window: `289`
  - matched_to_ibge_in_window: `287`
...
- **extras:**
  ...
  - orgs_by_source: `{'sc_compras': 0, 'ciga_dom': 565, 'dados_abertos_sc': 0}`
...
- **extras:**
  - source: `ciga_dom`
  - records: `37621`
  - observed_municipios: `289`
  - run_mode: `incremental`
  - summary_counts: `{'resources_available': 50, 'zips_available': 50, 'selected': 48, 'completed_resources_prior': 2, 'resources_processed_ok': 48, 'resources_failed': 0, 'resources_skipped_checkpoint': 0, 'files_processed': 48, 'files_skipped_checkpoint': 0, 'records_normalized': 37621, 'municipalities_observed': 289}`
...
- **extras:**
  ...
  - max_date_in_window: `2026-07-18`
  - records_with_date: `37621`
  - records_in_window: `37621`
...
- **extras:**
  - total_records_classified: `37621`
  ...
  - non_procurement_share_pct: `29.22`
- **distribution (top 15):**
  - ata_registro_precos: {'count': 15918, 'pct': 42.31}
  - outros: {'count': 9617, 'pct': 25.56}
  - outros_atos_contratacao: {'count': 2928, 'pct': 7.78}
  - homologacao: {'count': 1986, 'pct': 5.28}
  - termo_aditivo: {'count': 1367, 'pct': 3.63}
  - nao_relacionado: {'count': 1333, 'pct': 3.54}
  - extrato_contrato: {'count': 1205, 'pct': 3.2}
  - inexigibilidade: {'count': 672, 'pct': 1.79}
  - dispensa: {'count': 606, 'pct': 1.61}
  - aviso_licitacao: {'count': 530, 'pct': 1.41}
  - chamamento_publico: {'count': 275, 'pct': 0.73}
  - edital: {'count': 238, 'pct': 0.63}
  - credenciamento: {'count': 207, 'pct': 0.55}
  - retificacao: {'count': 200, 'pct': 0.53}
  - apostilamento: {'count': 159, 'pct': 0.42}
...
- **extras:**
  ...
  - mean_field_fill_pct: `94.06`
- **per_field:**
  - municipio: {'filled': 21977, 'total': 37621, 'pct': 58.42}
  - orgao: {'filled': 37621, 'total': 37621, 'pct': 100.0}
  - data: {'filled': 37621, 'total': 37621, 'pct': 100.0}
  - titulo: {'filled': 37621, 'total': 37621, 'pct': 100.0}
  - url: {'filled': 37621, 'total': 37621, 'pct': 100.0}
  - act_category: {'filled': 37621, 'total': 37621, 'pct': 100.0}
  - texto: {'filled': 37621, 'total': 37621, 'pct': 100.0}
...
- **period:** as of 2026-07-18T21:43:47.083711+00:00
- **confidence:** high
- **calc_date:** 2026-07-18
- **run_id:** `r2-n06c-entities`
- **sources:**
...
- **extras:**
  - last_collection_at: `2026-07-18T21:15:20.873518+00:00`
  - latest_business_date: `2026-07-18`
  - hours_since_collection: `0.47`
  - hours_since_latest_business_date: `21.73`
...
- **extras:**
  ...
  - hours_since_collection: `43.5`
  - hours_since_latest_business_date: `9189.73`
...
```json
{
  "ciga_dom": {
    ...
    "records": "/mnt/d/extra consultoria/output/ciga_dom/ciga-dom-20260718T211324Z-2c05d7be3f/publications.jsonl",
    "n_records": 37621,
