...
| ADR | Título | Status |
|-----|--------|--------|
| ADR-007 | Cloud hosting strategy | **Vigente** (provedor ainda não fechado operacionalmente) |
| ADR-007-v6.1 | Provider decision notes | **Vigente** (complementar) |
| ADR-008 | Infrastructure as code strategy | **Vigente** |
...
| ADR-023 | Architecture Reset Campaign 2026-07-20 | **Vigente** (charter; implementação faseada) |
