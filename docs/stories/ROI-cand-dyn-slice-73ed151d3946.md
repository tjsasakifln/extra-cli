# Story: [27. Organização e manutenção do código] Erros não são engolidos. · Não existem `except Exception: pass`. · Falhas externas possuem contexto. (+5 more)

**Story ID:** `ROI-cand-dyn-slice-73ed151d3946`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T163104Z`)  
**Candidate ID:** `cand-dyn-slice:73ed151d3946`  
**ROI:** `1.6535`  
**DoD refs:** 27. Organização e manutenção do código, Erros não são engolidos., Não existem `except Exception: pass`., Falhas externas possuem contexto., Logs não substituem tratamento de erro., Configuração é centralizada.
...
I want **[27. Organização e manutenção do código] Erros não são engolidos. · Não existem `except Exception: pass`. · Falhas externas possuem contexto. (+5 more)**,  
...
- cand-dyn-slice:e845e4e64aba ROI=1.6535 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
...
- Work defined by candidate `cand-dyn-slice:73ed151d3946` only
