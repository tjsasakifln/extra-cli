# Story: [13.1 Testes unitários] Classificação AEC.

**Story ID:** `ROI-cand-dyn-slice-b145bef1a4f6`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T134034Z`)  
**Candidate ID:** `cand-dyn-slice:b145bef1a4f6`  
**ROI:** `2.7848`  
**DoD refs:** 13.1 Testes unitários, Classificação AEC.
...
I want **[13.1 Testes unitários] Classificação AEC.**,  
...
- Work defined by candidate `cand-dyn-slice:b145bef1a4f6` only
...
| 2026-07-18 | @po | Ready |
| 2026-07-18 | @qa/@po | PASS dedupe AEC |
