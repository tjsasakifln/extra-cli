# Story: [Entregável E — editais abertos e recomendação indi] O relatório inclui editais comprovadamente abertos na data d · Cada edital foi visto no snapshot completo mais recente ou r · Cada edital é avaliad

**Story ID:** `ROI-cand-dyn-slice-9fada5fba964`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T184041Z`)  
**Candidate ID:** `cand-dyn-slice:9fada5fba964`  
**ROI:** `1.2261`  
**DoD refs:** Entregável E — editais abertos e recomendação individual, O relatório inclui editais comprovadamente abertos na data de corte ou semana de, Cada edital foi visto no snapshot completo mais recente ou reconfirmado individu, Cada edital é avaliado contra o perfil versionado da Extra., Cada edital recebe `GO`, `REVIEW` ou `NO_GO`., A apresentação ao cliente traduz `GO` e `NO_GO` como recomendação fundamentada d
...
I want **[Entregável E — editais abertos e recomendação indi] O relatório inclui editais comprovadamente abertos na data d · Cada edital foi visto no snapshot completo mais recente ou r · Cada edital é avaliad**,  
...
Open local-stage items in section 'Entregável E — editais abertos e recomendação individual' without VPS/live/human-accept blocker patterns
...
- Work defined by candidate `cand-dyn-slice:9fada5fba964` only
