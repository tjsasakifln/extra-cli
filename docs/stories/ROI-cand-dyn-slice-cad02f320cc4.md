# Story: [25. Verdade, linguagem e claims permitidos] Todo indicador possui definição. · Todo indicador possui fórmula. · Todo indicador possui denominador. (+5 more)

**Story ID:** `ROI-cand-dyn-slice-cad02f320cc4`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T125038Z`)  
**Candidate ID:** `cand-dyn-slice:cad02f320cc4`  
**ROI:** `4.3448`  
**DoD refs:** 25. Verdade, linguagem e claims permitidos, Todo indicador possui definição., Todo indicador possui fórmula., Todo indicador possui denominador., Todo indicador possui data de corte., Todo indicador possui fonte.
...
I want **[25. Verdade, linguagem e claims permitidos] Todo indicador possui definição. · Todo indicador possui fórmula. · Todo indicador possui denominador. (+5 more)**,  
...
- Work defined by candidate `cand-dyn-slice:cad02f320cc4` only
...
| 2026-07-18 | @po | Draft → Ready |
| 2026-07-18 | @qa | PASS |
| 2026-07-18 | @po | Closed; 7 DoD flips |
