# Story: [31. Documentação operacional] README não confunde alvo futuro com realidade atual. · PRD está alinhado ao DOD. · ADRs vigentes estão identificadas. (+5 more)

**Story ID:** `ROI-cand-dyn-slice-cfa643fd416d`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T131425Z`)  
**Candidate ID:** `cand-dyn-slice:cfa643fd416d`  
**ROI:** `3.0345`  
**DoD refs:** 31. Documentação operacional, README não confunde alvo futuro com realidade atual., PRD está alinhado ao DOD., ADRs vigentes estão identificadas., ADRs revogadas estão identificadas., Existe runbook de rollback.
...
I want **[31. Documentação operacional] README não confunde alvo futuro com realidade atual. · PRD está alinhado ao DOD. · ADRs vigentes estão identificadas. (+5 more)**,  
...
- cand-dyn-slice:7fea3748bec4 ROI=2.9241 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
...
- Work defined by candidate `cand-dyn-slice:cfa643fd416d` only
...
| 2026-07-18 | @po | Ready |
| 2026-07-18 | @qa/@po | PASS 7/8 flips; PRD open |
