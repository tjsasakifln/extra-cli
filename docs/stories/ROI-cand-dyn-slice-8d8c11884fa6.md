# Story: [Entregável A — ranking dos órgãos públicos] O sistema gera ranking dos entes do universo que contratam o · O ranking informa quantidade de contratações no período. · O ranking informa valor contratad

**Story ID:** `ROI-cand-dyn-slice-8d8c11884fa6`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T181419Z`)  
**Candidate ID:** `cand-dyn-slice:8d8c11884fa6`  
**ROI:** `1.2261`  
**DoD refs:** Entregável A — ranking dos órgãos públicos, O sistema gera ranking dos entes do universo que contratam obras e serviços comp, O ranking informa quantidade de contratações no período., O ranking informa valor contratado total., O ranking informa ticket médio com semântica explícita., O ranking informa frequência temporal de contratação.
...
I want **[Entregável A — ranking dos órgãos públicos] O sistema gera ranking dos entes do universo que contratam o · O ranking informa quantidade de contratações no período. · O ranking informa valor contratad**,  
...
Open local-stage items in section 'Entregável A — ranking dos órgãos públicos' without VPS/live/human-accept blocker patterns
...
- cand-dyn-slice:f7e09f20fb21 ROI=1.2261 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
- cand-dyn-slice:eda51a0354cf ROI=1.2261 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
- cand-dyn-slice:f07132d1a059 ROI=1.2261 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
- cand-dyn-slice:398d2a54cc21 ROI=1.2261 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
...
- Work defined by candidate `cand-dyn-slice:8d8c11884fa6` only
...
- [x] @qa independent PASS (residual live-schema/profile filter)
- [x] @po closed
- [x] @devops merge epic
- [x] DoD flipped after QA PASS + residual documented
