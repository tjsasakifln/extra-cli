# Story: [32.1 Fonte canônica de verdade] `DOD.md`, README, PRD, ADRs, runbooks, código, migrations, t · Nenhuma decisão obrigatória existe apenas em histórico de ch · Instruções específicas de ferramenta apen

**Story ID:** `ROI-cand-dyn-slice-a04da1ab4a07`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T161932Z`)  
**Candidate ID:** `cand-dyn-slice:a04da1ab4a07`  
**ROI:** `1.8067`  
**DoD refs:** 32.1 Fonte canônica de verdade, `DOD.md`, README, PRD, ADRs, runbooks, código, migrations, testes e artefatos ve, Nenhuma decisão obrigatória existe apenas em histórico de chat, memória de agent, Instruções específicas de ferramenta apenas apontam para documentos canônicos; n, `CLAUDE.md`, `AGENTS.md`, regras do Cursor e arquivos equivalentes não se contra, Existe um guia canônico de desenvolvimento, como `docs/DEVELOPMENT.md`, comparti
...
I want **[32.1 Fonte canônica de verdade] `DOD.md`, README, PRD, ADRs, runbooks, código, migrations, t · Nenhuma decisão obrigatória existe apenas em histórico de ch · Instruções específicas de ferramenta apen**,  
...
- Work defined by candidate `cand-dyn-slice:a04da1ab4a07` only
