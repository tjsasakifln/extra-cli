# Story: [13.4 Qualidade mínima] Nenhum gate obrigatório usa `|| true`.

**Story ID:** `ROI-cand-dyn-slice-1e78666e2a21`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T124230Z`)  
**Candidate ID:** `cand-dyn-slice:1e78666e2a21`  
**ROI:** `4.7241`  
**DoD refs:** 13.4 Qualidade mínima, Nenhum gate obrigatório usa `|| true`.
...
I want **[13.4 Qualidade mínima] Nenhum gate obrigatório usa `|| true`.**,  
...
- cand-dyn-slice:cad02f320cc4 ROI=4.3448 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
- cand-dyn-slice:16c84ec2cae0 ROI=4.3448 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
- cand-dyn-slice:a7365225983a ROI=4.3448 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
...
- Work defined by candidate `cand-dyn-slice:1e78666e2a21` only
...
| 2026-07-18 | @po | Draft → Ready (GO 9/10) |
| 2026-07-18 | @dev | Ready → InProgress → InReview; scanner + 6 tests |
| 2026-07-18 | @qa | CONCERNS (flip authorized); ban-marker evasion fixed post-QA |
| 2026-07-18 | @po | Closed after QA CONCERNS; DoD §13.4 || true flipped with evidence |
