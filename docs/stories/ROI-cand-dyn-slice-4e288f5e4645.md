# Story: [29. Rastreabilidade e auditoria] Cada execução possui `run_id`. · Cada execução possui versão do código. · Cada execução possui versão do schema. (+5 more)

**Story ID:** `ROI-cand-dyn-slice-4e288f5e4645`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T132549Z`)  
**Candidate ID:** `cand-dyn-slice:4e288f5e4645`  
**ROI:** `2.9241`  
**DoD refs:** 29. Rastreabilidade e auditoria, Cada execução possui `run_id`., Cada execução possui versão do código., Cada execução possui versão do schema., Cada execução possui hash da planilha., Cada execução possui fonte.
...
I want **[29. Rastreabilidade e auditoria] Cada execução possui `run_id`. · Cada execução possui versão do código. · Cada execução possui versão do schema. (+5 more)**,  
...
- Work defined by candidate `cand-dyn-slice:4e288f5e4645` only
