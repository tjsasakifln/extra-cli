# Story: [2.2 Escopo incluído] Monitoramento de editais abertos. · Reconciliação de status de editais. · Histórico de editais encerrados quando necessário para análi (+5 more)

**Story ID:** `ROI-cand-dyn-slice-eba1cdc41d81`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Draft  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T135416Z`)  
**Candidate ID:** `cand-dyn-slice:eba1cdc41d81`  
**ROI:** `2.4928`  
**DoD refs:** 2.2 Escopo incluído, Monitoramento de editais abertos., Reconciliação de status de editais., Histórico de editais encerrados quando necessário para análise., Coleta de contratos dos últimos três anos, no mínimo., Atualização incremental de contratos após o backfill inicial.
...
I want **[2.2 Escopo incluído] Monitoramento de editais abertos. · Reconciliação de status de editais. · Histórico de editais encerrados quando necessário para análi (+5 more)**,  
...
Open local-stage items in section '2.2 Escopo incluído' without VPS/live/human-accept blocker patterns
...
- cand-dyn-slice:96f337dd04a6 ROI=2.4928 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
...
- Work defined by candidate `cand-dyn-slice:eba1cdc41d81` only
