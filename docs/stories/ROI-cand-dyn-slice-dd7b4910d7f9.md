# Story: [Configuração do diagnóstico] Existe configuração canônica do perfil da Extra Construtora  · A configuração registra região e universo monitorado. · A configuração registra tipos de obra e serviços de
...
**ROI:** `1.2261`  
**DoD refs:** Configuração do diagnóstico, Existe configuração canônica do perfil da Extra Construtora ou mecanismo equival, A configuração registra região e universo monitorado., A configuração registra tipos de obra e serviços de engenharia relevantes., A configuração registra faixas de valor relevantes, quando definidas no alinhame, A configuração registra modalidades aceitas ou priorizadas.
...
I want **[Configuração do diagnóstico] Existe configuração canônica do perfil da Extra Construtora  · A configuração registra região e universo monitorado. · A configuração registra tipos de obra e serviços de**,  
...
Open local-stage items in section 'Configuração do diagnóstico' without VPS/live/human-accept blocker patterns
...
- Work defined by candidate `cand-dyn-slice:dd7b4910d7f9` only
