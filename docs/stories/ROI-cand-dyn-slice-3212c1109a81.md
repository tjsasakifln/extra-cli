# Story: [13.1 Testes unitários] Reconciliação de snapshot. · Classificação AEC.

**Story ID:** `ROI-cand-dyn-slice-3212c1109a81`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T133837Z`)  
**Candidate ID:** `cand-dyn-slice:3212c1109a81`  
**ROI:** `2.7848`  
**DoD refs:** 13.1 Testes unitários, Reconciliação de snapshot., Classificação AEC.
...
I want **[13.1 Testes unitários] Reconciliação de snapshot. · Classificação AEC.**,  
...
- Work defined by candidate `cand-dyn-slice:3212c1109a81` only
