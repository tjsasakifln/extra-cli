# Story: [25. Verdade, linguagem e claims permitidos]  · Ausência de dados não é chamada de ausência de licitação sem · Vencedor conhecido não é chamado de conjunto completo de con (+5 more)

**Story ID:** `ROI-cand-dyn-slice-d7ab09cdef56`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T125719Z`)  
**Candidate ID:** `cand-dyn-slice:d7ab09cdef56`  
**ROI:** `4.3448`  
**DoD refs:** 25. Verdade, linguagem e claims permitidos, , Ausência de dados não é chamada de ausência de licitação sem consulta válida., Vencedor conhecido não é chamado de conjunto completo de concorrentes., Participante não identificado não é tratado como inexistente., Win rate não é calculado sem propostas enviadas.
...
I want **[25. Verdade, linguagem e claims permitidos]  · Ausência de dados não é chamada de ausência de licitação sem · Vencedor conhecido não é chamado de conjunto completo de con (+5 more)**,  
...
- cand-dyn-slice:bb922abe2098 ROI=4.3448 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
...
- Work defined by candidate `cand-dyn-slice:d7ab09cdef56` only
