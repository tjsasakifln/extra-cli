# Story: [14. Backup e recuperação local] Existe backup local do PostgreSQL. · O restore foi testado em banco separado. · O restore recompõe migrations. (+5 more)

**Story ID:** `ROI-cand-dyn-slice-e09964d21645`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T134159Z`)  
**Candidate ID:** `cand-dyn-slice:e09964d21645`  
**ROI:** `2.5`  
**DoD refs:** 14. Backup e recuperação local, Existe backup local do PostgreSQL., O restore foi testado em banco separado., O restore recompõe migrations., O restore recompõe dados., O restore recompõe o universo-alvo.
...
I want **[14. Backup e recuperação local] Existe backup local do PostgreSQL. · O restore foi testado em banco separado. · O restore recompõe migrations. (+5 more)**,  
...
- Work defined by candidate `cand-dyn-slice:e09964d21645` only
...
| 2026-07-18 | @po | Ready |
| 2026-07-18 | @qa/@po | PASS live backup restore; universe reimport left open |
