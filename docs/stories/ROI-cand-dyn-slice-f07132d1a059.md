# Story: [Entregável C — contratos vincendos em 90 a 180 dia] O sistema identifica contratos compatíveis com o perfil cuja · A data de término usada possui fonte e data de verificação. · Contratos sem data de 

**Story ID:** `ROI-cand-dyn-slice-f07132d1a059`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T182742Z`)  
**Candidate ID:** `cand-dyn-slice:f07132d1a059`  
**ROI:** `1.2261`  
**DoD refs:** Entregável C — contratos vincendos em 90 a 180 dias, O sistema identifica contratos compatíveis com o perfil cuja vigência termina em, A data de término usada possui fonte e data de verificação., Contratos sem data de vigência não entram silenciosamente na lista., Prorrogações e aditivos conhecidos atualizam a data efetiva., O sistema distingue vencimento contratual de término estimado.
...
I want **[Entregável C — contratos vincendos em 90 a 180 dia] O sistema identifica contratos compatíveis com o perfil cuja · A data de término usada possui fonte e data de verificação. · Contratos sem data de **,  
...
Open local-stage items in section 'Entregável C — contratos vincendos em 90 a 180 dias' without VPS/live/human-accept blocker patterns
...
- Work defined by candidate `cand-dyn-slice:f07132d1a059` only
