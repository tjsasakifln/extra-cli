# Story: [2.1 Objetivo] O sistema ajuda a localizar editais relevantes para a Extra  · O sistema ajuda a verificar contratos históricos dos entes m · O sistema ajuda a identificar vencedores e concorrentes obs

**Story ID:** `ROI-cand-dyn-slice-8e8eb18e2c5f`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T135012Z`)  
**Candidate ID:** `cand-dyn-slice:8e8eb18e2c5f`  
**ROI:** `2.4928`  
**DoD refs:** 2.1 Objetivo, O sistema ajuda a localizar editais relevantes para a Extra Construtora., O sistema ajuda a verificar contratos históricos dos entes monitorados., O sistema ajuda a identificar vencedores e concorrentes observáveis., O sistema ajuda a formar referências de valores com semântica explícita., O sistema ajuda Tiago a decidir quais oportunidades merecem análise humana.
...
I want **[2.1 Objetivo] O sistema ajuda a localizar editais relevantes para a Extra  · O sistema ajuda a verificar contratos históricos dos entes m · O sistema ajuda a identificar vencedores e concorrentes obs**,  
...
Open local-stage items in section '2.1 Objetivo' without VPS/live/human-accept blocker patterns
...
- cand-dyn-slice:0193739b5c78 ROI=2.4928 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
- cand-dyn-slice:83050e78f159 ROI=2.4928 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
- cand-dyn-slice:0f3d11d333c2 ROI=2.4928 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
...
- Work defined by candidate `cand-dyn-slice:8e8eb18e2c5f` only
...
| 2026-07-18 | @po | Ready |
| 2026-07-18 | @qa/@po | PASS inventory; PARTIAL left open |
