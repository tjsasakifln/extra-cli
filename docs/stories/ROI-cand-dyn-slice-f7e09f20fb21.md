# Story: [Entregável B — mapeamento de 15 concorrentes obser] O sistema consegue selecionar e justificar pelo menos 15 for · A seleção dos 15 possui regra reproduzível e configurável. · Cada fornecedor possui 

**Story ID:** `ROI-cand-dyn-slice-f7e09f20fb21`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T182121Z`)  
**Candidate ID:** `cand-dyn-slice:f7e09f20fb21`  
**ROI:** `1.2261`  
**DoD refs:** Entregável B — mapeamento de 15 concorrentes observáveis, O sistema consegue selecionar e justificar pelo menos 15 fornecedores vencedores, A seleção dos 15 possui regra reproduzível e configurável., Cada fornecedor possui CNPJ ou identidade canônica., Cada fornecedor possui quantidade de contratos identificados., Cada fornecedor possui valor contratado total.
...
I want **[Entregável B — mapeamento de 15 concorrentes obser] O sistema consegue selecionar e justificar pelo menos 15 for · A seleção dos 15 possui regra reproduzível e configurável. · Cada fornecedor possui **,  
...
Open local-stage items in section 'Entregável B — mapeamento de 15 concorrentes observáveis' without VPS/live/human-accept blocker patterns
...
- cand-dyn-slice:b9dd47d02782 ROI=1.2261 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
...
- Work defined by candidate `cand-dyn-slice:f7e09f20fb21` only
...
- [x] @qa independent PASS (residual live DSN wire)
- [x] @po closed
- [x] @devops merge epic
