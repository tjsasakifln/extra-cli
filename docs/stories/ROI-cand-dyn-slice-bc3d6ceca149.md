# Story: [2.4 Usuário e forma de uso] Tiago é o único usuário obrigatório do sistema. · O fluxo principal pode ser executado sem interface web. · Os comandos principais são claros e documentados. (+5 more)

**Story ID:** `ROI-cand-dyn-slice-bc3d6ceca149`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T135641Z`)  
**Candidate ID:** `cand-dyn-slice:bc3d6ceca149`  
**ROI:** `2.4928`  
**DoD refs:** 2.4 Usuário e forma de uso, Tiago é o único usuário obrigatório do sistema., O fluxo principal pode ser executado sem interface web., Os comandos principais são claros e documentados., O sistema não exige conhecimento do código interno para tarefas operacionais rec, A saída é legível para revisão humana.
...
I want **[2.4 Usuário e forma de uso] Tiago é o único usuário obrigatório do sistema. · O fluxo principal pode ser executado sem interface web. · Os comandos principais são claros e documentados. (+5 more)**,  
...
- cand-dyn-slice:49022ba84875 ROI=2.4928 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
...
- Work defined by candidate `cand-dyn-slice:bc3d6ceca149` only
