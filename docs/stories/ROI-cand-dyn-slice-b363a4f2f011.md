# Story: [31. Documentação operacional] Existe runbook de rollback.

**Story ID:** `ROI-cand-dyn-slice-b363a4f2f011`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T132318Z`)  
**Candidate ID:** `cand-dyn-slice:b363a4f2f011`  
**ROI:** `3.0345`  
**DoD refs:** 31. Documentação operacional, Existe runbook de rollback.
...
I want **[31. Documentação operacional] Existe runbook de rollback.**,  
...
- Work defined by candidate `cand-dyn-slice:b363a4f2f011` only
