# Story: [25. Verdade, linguagem e claims permitidos]  · Nenhum documento promete capacidade fora do escopo. · README, PRD, DOD, manifests e relatórios usam as mesmas defi (+1 more)

**Story ID:** `ROI-cand-dyn-slice-a41d7a2033b7`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T130315Z`)  
**Candidate ID:** `cand-dyn-slice:a41d7a2033b7`  
**ROI:** `4.3448`  
**DoD refs:** 25. Verdade, linguagem e claims permitidos, , Nenhum documento promete capacidade fora do escopo., README, PRD, DOD, manifests e relatórios usam as mesmas definições., Números conflitantes são eliminados ou contextualizados historicamente.
...
I want **[25. Verdade, linguagem e claims permitidos]  · Nenhum documento promete capacidade fora do escopo. · README, PRD, DOD, manifests e relatórios usam as mesmas defi (+1 more)**,  
...
- Work defined by candidate `cand-dyn-slice:a41d7a2033b7` only
