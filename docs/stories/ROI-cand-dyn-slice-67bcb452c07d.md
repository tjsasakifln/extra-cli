# Story: [29. Rastreabilidade e auditoria] Overrides manuais possuem motivo. · Overrides manuais possuem data. · Overrides manuais possuem autor. (+5 more)

**Story ID:** `ROI-cand-dyn-slice-67bcb452c07d`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T133025Z`)  
**Candidate ID:** `cand-dyn-slice:67bcb452c07d`  
**ROI:** `2.9241`  
**DoD refs:** 29. Rastreabilidade e auditoria, Overrides manuais possuem motivo., Overrides manuais possuem data., Overrides manuais possuem autor., A evidência de coverage pode ser reconstruída., A evidência de `success_zero` pode ser reconstruída.
...
I want **[29. Rastreabilidade e auditoria] Overrides manuais possuem motivo. · Overrides manuais possuem data. · Overrides manuais possuem autor. (+5 more)**,  
...
- Work defined by candidate `cand-dyn-slice:67bcb452c07d` only
...
| 2026-07-18 | @po | Ready |
| 2026-07-18 | @qa/@po | PASS 3/8 overrides; reconstruct left open |
