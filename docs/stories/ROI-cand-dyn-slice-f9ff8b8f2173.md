...
**Story ID:** `ROI-cand-dyn-slice-f9ff8b8f2173`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Draft  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T135238Z`)  
**Candidate ID:** `cand-dyn-slice:f9ff8b8f2173`  
**ROI:** `2.4928`  
...
- Work defined by candidate `cand-dyn-slice:f9ff8b8f2173` only
...
| 2026-07-18 | @qa/@po | PASS PARTIAL annotations |
