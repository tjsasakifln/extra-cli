# Story: [13.3 Testes de contrato com fontes] Endpoint PNCP válido. · Schema PNCP esperado. · Paginação PNCP válida. (+5 more)

**Story ID:** `ROI-cand-dyn-slice-fb519704765b`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T161541Z`)  
**Candidate ID:** `cand-dyn-slice:fb519704765b`  
**ROI:** `1.8067`  
**DoD refs:** 13.3 Testes de contrato com fontes, Endpoint PNCP válido., Schema PNCP esperado., Paginação PNCP válida., Endpoint PCP válido., Schema PCP esperado.
...
I want **[13.3 Testes de contrato com fontes] Endpoint PNCP válido. · Schema PNCP esperado. · Paginação PNCP válida. (+5 more)**,  
...
- Work defined by candidate `cand-dyn-slice:fb519704765b` only
