# Story: [23. Observabilidade e alertas] Retenção de journald está configurada. · Uso de disco é monitorado. · Uso de memória é monitorado. (+5 more)

**Story ID:** `ROI-cand-dyn-slice-eb87220940fd`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T141528Z`)  
**Candidate ID:** `cand-dyn-slice:eb87220940fd`  
**ROI:** `2.0962`  
**DoD refs:** 23. Observabilidade e alertas, Retenção de journald está configurada., Uso de disco é monitorado., Uso de memória é monitorado., Load average é monitorado., Crescimento do banco é monitorado.
...
I want **[23. Observabilidade e alertas] Retenção de journald está configurada. · Uso de disco é monitorado. · Uso de memória é monitorado. (+5 more)**,  
...
- cand-dyn-slice:8c34448897c1 ROI=2.0962 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
- cand-dyn-slice:07f775017651 ROI=2.0962 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
- cand-dyn-slice:d0816ba4d04c ROI=2.0962 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
...
- Work defined by candidate `cand-dyn-slice:eb87220940fd` only
...
**Verdict:** PASS (re-QA after psycopg2 fix)  
**Reviewer:** adversarial-qa-auditor / Quinn (@qa)  
**Cycle:** `cyc-2026-07-18T141528Z`  
**Reviewed commit:** `53508bd8625d6c27fcc4bf5e0d9ac3c7a71d502a`  
**Artifact:** `squads/extra-dod-roi/state/qa/cyc-2026-07-18T141528Z-qa.json`  
**Independence:** true (not implementer)  
**DoD pre-flip:** none (AC3 honored)

### Evidence re-run
- `pytest tests/test_host_monitor.py -q --no-cov` → 5 passed
- `LOCAL_DATALAKE_DSN=postgresql://test:test@127.0.0.1:5433/extra_test python3 -m scripts.ops.host_monitor --json` → **overall=ok**; journald `configured` (`applied_on_host=false`); disk/mem/load ok; **postgres=ok** `db_size=19550691 dead_tuples=0 autovacuum_tables=4`
- Prior issue (psycopg import) **resolved** in `53508bd`

### DoD items authorized to flip after this PASS (exactly **8**)
1. `dod:72ef5e2b3706` — Retenção de journald está configurada.
2. `dod:db243638a29b` — Uso de disco é monitorado.
3. `dod:48665f2a7d99` — Uso de memória é monitorado.
4. `dod:1a0d2180f7f5` — Load average é monitorado.
5. `dod:d1a81a2f85bc` — Crescimento do banco é monitorado.
6. `dod:8715a2117e44` — Dead tuples são monitoradas.
7. `dod:6f1550e7e2a7` — Autovacuum é monitorado.
8. `dod:45800e32969d` — Tiago consegue consultar saúde geral com um comando.

### Must stay open
- Duração dos crawlers (not implemented; crawler/HTTP/alert/timer flips forbidden)
- HTTP 403/429/5xx, timers, alertas
...
| 2026-07-18 | @po | Ready |
| 2026-07-18 | delivery-engineer | host_monitor + journald config (DoD flip after QA) |
| 2026-07-18 | @qa adversarial | PASS — 4 flips; PG blocked on psycopg import |
| 2026-07-18 | delivery-engineer | fix psycopg2 for PG growth [53508bd] |
| 2026-07-18 | @qa adversarial | re-QA PASS — expand to 8 flips (PG+Tiago); crawler open |

---

*Generated by squads/extra-dod-roi/scripts/materialize_aiox_story.py — do not hand-edit candidate_id binding.*
| 2026-07-18 | @po | Closed QA PASS; flipped 8 host-monitor DoD items |
