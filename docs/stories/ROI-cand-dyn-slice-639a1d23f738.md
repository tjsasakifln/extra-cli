# Story: [27. Organização e manutenção do código] Constantes de domínio são centralizadas. · URLs de fontes são centralizadas. · Defaults são documentados. (+5 more)

**Story ID:** `ROI-cand-dyn-slice-639a1d23f738`  
**Epic:** EPIC-EXTRA-DOD-ROI (evergreen)  
**Status:** Done  
**Risk level:** **HIGH-RISK**  
**Source:** squad `extra-dod-roi` force-next (cycle `cyc-2026-07-18T163405Z`)  
**Candidate ID:** `cand-dyn-slice:639a1d23f738`  
**ROI:** `1.6535`  
**DoD refs:** 27. Organização e manutenção do código, Constantes de domínio são centralizadas., URLs de fontes são centralizadas., Defaults são documentados., Mudanças de métrica exigem atualização da definição., Código legado possui plano de remoção.
...
I want **[27. Organização e manutenção do código] Constantes de domínio são centralizadas. · URLs de fontes são centralizadas. · Defaults são documentados. (+5 more)**,  
...
- cand-dyn-slice:0983d8e17109 ROI=1.6535 preterido vs #1: menor combinação gate+risco+evidência ou maior custo/dependência externa
...
- Work defined by candidate `cand-dyn-slice:639a1d23f738` only
