# A apresentação ao cliente traduz GO/NO_GO como PARTICIPAR/NÃO PARTICIPAR, preservando REVIEW.

## Given/When/Then
- Given live deliverable E audit from opportunity_intel
- When audit_report(operational=True) runs
- Then check `client_labels` is PASS and recommendation_count > 0
