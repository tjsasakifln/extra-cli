...
- [x] O golden path calcula cobertura. Evidência: method_acceptance=PASS (dual_capability_coverage/1.2.0 + source_policy v2.0.0 active sha256=867d77b3…) · live_operational_state: measurement_success=true identity_unresolved_count=0 dual_gate_status=FAIL den≈946 never_checked (coverage_gate FAIL, not 95%) · pack `.dod/evidence/DOD-rol-1-definition-of-done-1fdea0f6e6/` supersedes `4efe05fc94` (SUPERSEDED post-semantic-change) · PR dual-canonical-closure · **não** afirma 95% live nem LOCAL_READY.
