...
- [x] O golden path calcula cobertura. Evidência: PR #108 merge `edd7618` · CI main `29887826689` SUCCESS · method=`dual_capability_coverage` (ADR-030) · open_tenders+historical_contracts independent · reproof main den=1093 num=0 never_checked=1093 gate FAIL · measurement_success=true · CLI `--execute-dual-coverage-only` · pack `.dod/evidence/DOD-rol-1-definition-of-done-4efe05fc94/` · legado 214/1093=19.5791% SUPERSEDED (ERRATA-19-5791.md) · **não** afirma 95% live.
