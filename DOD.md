...
- [x] O golden path gera relatório de editais. Evidência: `scripts/reports/golden_path_pack.py` + pack/evidence-pack (editais.csv N=8, contratos.csv N=0+limitação, concorrentes.csv, referencias_valores.csv) + PDF real size=2338 magic %PDF + tests/test_golden_path_pack.py (2 passed) + panorama --output-pdf real + QA PASS cyc-2026-07-18T151824Z.
- [x] O golden path gera relatório de contratos. Evidência: `scripts/reports/golden_path_pack.py` + pack/evidence-pack (editais.csv N=8, contratos.csv N=0+limitação, concorrentes.csv, referencias_valores.csv) + PDF real size=2338 magic %PDF + tests/test_golden_path_pack.py (2 passed) + panorama --output-pdf real + QA PASS cyc-2026-07-18T151824Z.
- [x] O golden path gera relatório de concorrentes. Evidência: `scripts/reports/golden_path_pack.py` + pack/evidence-pack (editais.csv N=8, contratos.csv N=0+limitação, concorrentes.csv, referencias_valores.csv) + PDF real size=2338 magic %PDF + tests/test_golden_path_pack.py (2 passed) + panorama --output-pdf real + QA PASS cyc-2026-07-18T151824Z.
- [x] O golden path gera relatório de referências de valores. Evidência: `scripts/reports/golden_path_pack.py` + pack/evidence-pack (editais.csv N=8, contratos.csv N=0+limitação, concorrentes.csv, referencias_valores.csv) + PDF real size=2338 magic %PDF + tests/test_golden_path_pack.py (2 passed) + panorama --output-pdf real + QA PASS cyc-2026-07-18T151824Z.
...
- [x] O golden path gera PDF. Evidência: `scripts/reports/golden_path_pack.py` + pack/evidence-pack (editais.csv N=8, contratos.csv N=0+limitação, concorrentes.csv, referencias_valores.csv) + PDF real size=2338 magic %PDF + tests/test_golden_path_pack.py (2 passed) + panorama --output-pdf real + QA PASS cyc-2026-07-18T151824Z.
...
- [x] O golden path pode ser executado em ambiente limpo. Evidência: `python3 -m scripts.ops.golden_clean_env` + report.json ok=true, create_exit=0, public_tables=76, golden_path.exit=0 + session-2026-07-18-golden-clean + QA PASS cyc-2026-07-18T152722Z.
